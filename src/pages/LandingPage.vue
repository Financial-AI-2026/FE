...
.globe-photo {
  ...
  /* 원본 사진의 어두운 반구가 아래쪽(잘려서 보이는 쪽)으로 오도록 */
...
.badge {
  ...
  border:
    1px solid
    rgba(168, 116, 255, 0.35);

  background:
    rgba(168, 116, 255, 0.14);
